...
public class materikelas1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materikelas1);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri localUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.novi1);
                mVideoView.start();
                ...
                lefticon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(materikelas1.this, "You clicked in left ico", Toast.LENGTH_SHORT).show();
                    }
                });
